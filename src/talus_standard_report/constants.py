"""src/talus_standard_report/constants.py module."""
...
MAX_NUM_PROTEINS_HEATMAP: Final = 100
MAX_NUM_PEPTIDES_HEATMAP: Final = 100
MIN_PEPTIDES_HIT_SELECTION: Final = 2
MAX_NAN_VALUES_HIT_SELECTION: Final = 2
